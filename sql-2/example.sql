...
INSERT INTO customer_tier (id, tier_level, create_timestamp) VALUES (1, 'Gold', CURRENT_TIMESTAMP);
ALTER TABLE customer_tier DROP CONSTRAINT tier_level_check;
INSERT INTO customer_tier (id, tier_level, create_timestamp) VALUES (2, 'Platinum', CURRENT_TIMESTAMP);

-- Data Manipulation
INSERT INTO customer_tier (id, tier_level, create_timestamp) VALUES (3, 'Silver', CURRENT_TIMESTAMP);
UPDATE customer_tier SET tier_level = 'Diamond' WHERE id = 3;
...
select * from public.film where film_id between 1 and 2000;
...
-- index --
-- explain analyze
explain select * from public.film where mov_year = 2001;
...
-- After Partition
explain analyze select * from public.rental_partitioned where DATE(rental_date) = '2005-08-01';
